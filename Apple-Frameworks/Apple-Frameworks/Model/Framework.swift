...
struct Framework: Hashable, Identifiable{ // Very important to conform objects to Hashable and Idetifiable
    let id = UUID() // Initialise an identifier that will be tracked
    let name: String
